!function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.MCDatepicker = e() : t.MCDatepicker = e()
}(self, (function () {
    return (() => {
        "use strict";
        var t = {
            853: (t, e, n) => {
                ...
                var l = function (t) {
                    ...
                    }, customOkBTN: function (t) {
                        return l(t).string()
                    }, customClearBTN: function (t) {
                        return l(t).string()
                    }, customCancelBTN: function (t) {
                        return l(t).string()
                    }, firstWeekday: function (t) {
                ...
                function b(t, e) {
                    ...
                    var n, a, r = function (t, e) {
                        if (null == t) return {};
                        var n, a, r = {}, c = Object.keys(t);
                        for (a = 0; a < c.length; a++) n = c[a], e.indexOf(n) >= 0 || (r[n] = t[n]);
                        return r
                    }(t, e);
                    if (Object.getOwnPropertySymbols) {
                        var c = Object.getOwnPropertySymbols(t);
                        for (a = 0; a < c.length; a++) n = c[a], e.indexOf(n) >= 0 || Object.prototype.propertyIsEnumerable.call(t, n) && (r[n] = t[n])
                    }
                    return r
                }
                ...
                function _(t, e, n) {
                    var a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, r = a.duration,
                        c = void 0 === r ? 150 : r, i = a.easing, o = void 0 === i ? "ease-in-out" : i,
                        l = b(a, ["duration", "easing"]),
                        d = "prev" === n ? t.offsetWidth : "next" === n ? -1 * t.offsetWidth : null,
                        s = y({duration: c, easing: o}, l);
                    return Promise.all([t.animate([{transform: "translateX(0px)"}, {transform: "translateX(".concat(d, "px)")}], s).finished, e.animate([{transform: "translateX(".concat(-1 * d, "px)")}, {transform: "translateX(0px)"}], s).finished]).then((function () {
                ...
                var k = function () {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new Date,
                        e = arguments.length > 1 ? arguments[1] : void 0, n = e.customWeekDays, a = e.customMonths,
                        r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "dd-mmm-yyyy";
                    if (l(t).date() && d(r.toLocaleLowerCase()).isValid()) {
                        var c = t.getDay(), i = t.getDate(), o = t.getMonth(), s = t.getFullYear(), u = {
                            d: String(i),
                    ...
                    var n = function (t, e) {
                            var n = window.innerWidth, a = window.innerHeight, r = document.body.offsetHeight, c = D(e),
                                i = D(t);
                            return {
                                vw: n,
                                vh: a,
                        ...
                        }(t, e), a = n.cal, r = n.elem, c = n.vw, i = n.vh, o = n.dh, l = n.elementOffsetTop,
                        d = n.elementOffsetleft, s = function (t) {
                            var e = t.elem, n = t.cal;
                            return {
                                t: e.t - n.h - 10,
                                b: e.b + n.h + 10,
                            ...
                            var e = t.elementOffsetTop, n = t.elem, a = t.cal;
                            return {t: e - a.h - 10, b: e + n.h + a.h + 10}
                        }(n), m = s.l > 0, v = c > s.r, f = s.t > 0, p = i > s.b, y = u.t > 0, h = o > u.b, b = null,
                        g = null;
                ...
                const C = {
                    ...
                    daterange: !1,
                    events: [],
                    eventColorScheme: [{type: "high", color: "#157EFB"}, {
                        type: "medium",
                        color: "#008E84"
                    }, {type: "low", color: "#157EFBv"}, {type: "slight", color: "#157EFB"}]
                };
                var M = function (t, e) {
                ...
                var E = function () {
                    ...
                    return {date: t, day: t.getDay(), dateNumb: t.getDate(), month: t.getMonth(), classList: []}
                }, S = function (t, e) {
                    var n = t.options, a = t.pickedDate, r = new Date(e.getFullYear(), e.getMonth(), 1),
                        c = r.getMonth(), i = function (e) {
                            var r = ["mc-date"];
                            return !function (t, e) {
                                return e.month === t
                            }(c, e) || function (t, e) {
                                var n = t.minDate, a = t.maxDate, r = e.date, c = null !== n && w(r) < w(n),
                                    i = null !== a && w(a) < w(r);
                                return c || i
                            }(n, e) || function (t, e) {
                                var n = t.disableWeekends, a = e.day;
                                return !!n && (0 === a || 6 === a)
                            }(n, e) || function (t, e) {
                                var n = t.disableWeekDays, a = e.day;
                                return !!n.length && n.some((function (t) {
                                    return t === a
                                }))
                            }(n, e) || function (t, e) {
                                var n = t.disableDates, a = e.date;
                                return !!n.length && n.some((function (t) {
                                    return w(t) === w(a)
                                }))
                                ...
                                var n = t.options, a = t.markCustomCallbacks, r = e.date,
                    ...
                    return function (t, e) {
                        var n = [], a = t.firstWeekday, r = -1 * (e.getDay() - (a - 7) % 7 - 1) % 7;
                        for (r = r > -6 ? r : 1; n.length < 42;) {
                            var c = new Date(e), i = new Date(c.setDate(r++));
                            n.push(E(i))
                        }
                        return n
                    }(n, r).map((function (t) {
                ...
                var L = "hide-calendar", T = "show-calendar", j = "month-change", N = "year-change", P = "date-pick",
                    A = function (t, e) {
                        t.dispatchEvent(new CustomEvent(T, {bubbles: !0, detail: {input: e}}))
                    }, B = function (t) {
                        t.dispatchEvent(new CustomEvent(L, {bubbles: !0}))
                    }, q = function (t, e) {
                        t.dispatchEvent(new CustomEvent(j, {bubbles: !0, detail: {direction: e}}))
                    }, Y = function (t, e) {
                        t.dispatchEvent(new CustomEvent(N, {bubbles: !0, detail: {direction: e}}))
                    }, F = function (t, e, n) {
                        var a = t.displayDay, r = t.displayDate, c = t.displayMonth, i = t.displayYear,
                            o = e.customWeekDays, l = e.customMonths;
                        a.innerText = o[n.getDay()], r.innerText = n.getDate(), c.innerText = l[n.getMonth()], i.innerText = n.getFullYear()
                    }, W = function (t, e, n) {
                        var a = t.dateCells, r = e.options, c = S(e, n);
                        !function (t, e, n) {
                            var a = t.monthNavPrev, r = t.monthNavNext, c = t.yearNavPrev, i = t.yearNavNext, o = e.minDate,
                                l = e.maxDate, d = e.jumpToMinMax, s = n.getMonth(), u = n.getFullYear(), m = x(a),
                                v = x(r), f = x(c), p = x(i);
                            if (null !== o) {
                                var y = w(o), h = w(new Date(u - 1, s + 1, 0)), b = w(new Date(u, s));
                                d ? b > y ? f.active() : f.inactive() : y > h ? f.inactive() : f.active(), b > y ? m.active() : m.inactive()
                            } else f.active(), m.active();
                            if (null !== l) {
                                var g = w(l), _ = w(new Date(u, s + 1, 0)), k = w(new Date(u + 1, s, 1));
                        ...
                        var n = e.options, a = e.pickedDate, r = n.showCalendarDisplay, c = n.bodyType, i = n.minDate,
                            o = n.maxDate, l = t.calendar, d = t.calendarDisplay;
                        ...
                        !function (t, e) {
                            var n = t.weekdays, a = e.customWeekDays, r = e.firstWeekday;
                            n.forEach((function (t, e) {
                                var n = (r + e) % a.length;
                                t.innerText = a[n].substr(0, 2)
                            }))
                        }(t, n), function (t, e) {
                            var n = e.customOkBTN, a = e.customClearBTN, r = e.customCancelBTN, c = t.okButton,
                                i = t.clearButton, o = t.cancelButton;
                            c.innerText = n, i.innerText = a, o.innerText = r
                        }(t, n), W(t, e, s), function (t, e, n) {
                            var a = t.currentMonthSelect, r = t.currentYearSelect, c = e.customMonths;
                        ...
                        var n = function (t) {
                            ...
                            }(t), a = n.calendar, r = n.currentMonthSelect, c = n.currentYearSelect, i = n.monthNavPrev,
                            o = n.monthNavNext, l = n.yearNavPrev, d = n.yearNavNext, s = n.dateCells, u = n.cancelButton,
                            m = n.okButton, v = n.clearButton, f = null, p = null, y = !0;
                        a.addEventListener(T, (function (t) {
                            p = e.find((function (e) {
                                return e.el === t.detail.input
                            })), H(n, p), a.classList.add("mc-calendar--opened"), function (t, e) {
                                var n = t.calendar, a = e.options, r = e.linkedElement;
                                if ("inline" === a.bodyType) {
                                    var c = O(n, r), i = c.top, o = c.left;
                            ...
                            if (y) {
                                y = !y;
                                var r = t.target.children[0].innerText, i = c.children[0].innerText,
                                    o = function (t, e, n) {
                                        var a = 0, r = t.indexOf(e), c = (r + 1) % t.length,
                                            i = ((r - 1) % t.length + t.length) % t.length, o = "next" === n ? c : i;
                                        return "next" === n && r > o && a++, "prev" === n && r < o && a--, {
                                            newElement: t[o],
                                            overlap: a
                                        }
                                    }(e, r, t.detail.direction), l = o.newElement, d = o.overlap;
                            ...
                            var e = p.options, i = e.minDate, o = e.maxDate;
                            if (y) {
                                y = !y;
                                var l = p.options.customMonths, d = r.children[0].innerText,
                                    s = t.target.children[0].innerText, u = "next" === t.detail.direction,
                                    m = u ? Number(s) + 1 : Number(s) - 1, v = l.indexOf(r.children[0].innerHTML),
                                    h = new Date(Number(s) - 1, v + 1, 0), b = new Date(Number(s) + 1, v),
                                    g = null !== i && !u && w(h) < w(i), k = null !== o && u && w(o) < w(b);
                                if (g || k) {
                                    var D = g && i || k && o, O = D.getMonth(), x = D.getFullYear();
        ...
        }, n.o = (t, e) => Object.prototype.hasOwnProperty.call(t, e), n(853)
    })().default
}));